...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse_answer(self, response):
        ans_json = json.loads(response.text, encoding="utf-8")
    ...
    def start_requests(self):
        ...
        browser.find_element_by_css_selector(".SignFlow-accountInput.Input-wrapper input").send_keys("13089971595")
        browser.find_element_by_css_selector(".SignFlow-password input").send_keys("Hanbing45")
        ...
        for cookie in Cookies:
            # 写入文件
            f = open("cookies/"+cookie['name'] + '.zhihu', 'wb')
